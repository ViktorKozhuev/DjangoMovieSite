    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(default=1900, verbose_name='Дата выхода')),
                ...
                ('genres', models.ManyToManyField(to='movies.actor', verbose_name='жанры')),
            ],
            options={
                'verbose_name': 'Фильм',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('star', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movies.reitngstar', verbose_name='звезда')),
            ],
            options={
